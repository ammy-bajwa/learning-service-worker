"use strict";
var precacheConfig = [["/index.html", "ab182ff0c559693ceae66ad0dce81a2c"], ["/static/css/main.c17080f1.css", "302476b8b379a677f648aa1e48918ebd"], ["/static/js/main.0f2e87dc.js", "0e642184856f27b97927cec0695da577"], ["/static/media/logo.5d5d9eef.svg", "5d5d9eefa31e5e13a6610d9fa7a283bb"]]
...
self.addEventListener("fetch", function(t) {
    if (t.request.url.startsWith("https://api.github.com/users/")) {
        caches.open('githubUsers').then( (cache) => {
          return fetch(t.request).then( (response) =>{
            cache.put(t.request.url, response.clone());
            return response;
          })
        })
      }
